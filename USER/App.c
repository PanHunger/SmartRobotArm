	...
	if(Ps2TimeCount > 50)
	{
		...
		if(mode == 1)
		{
				...
				switch( PS2KeyValue )
            {
							//根据按下的按键，控制舵机转动
              case PSB_PAD_LEFT:
                ServoSetPluseAndTime( 6, ServoPwmDutySet[6] + 30, 50 );
                break;
              case PSB_PAD_RIGHT:
                ServoSetPluseAndTime( 6, ServoPwmDutySet[6] - 30, 50 );
                break;
              case PSB_PAD_UP:
                ServoSetPluseAndTime( 5, ServoPwmDutySet[5] + 30, 50 );
                break;
              case PSB_PAD_DOWN:
                ServoSetPluseAndTime( 5, ServoPwmDutySet[5] - 30, 50 );
                break;
              case PSB_L1:
                ServoSetPluseAndTime( 2, ServoPwmDutySet[2] - 30, 50 );
                break;
              case PSB_L2:
                ServoSetPluseAndTime( 1, ServoPwmDutySet[1] + 30, 50 );
                break;
              case PSB_TRIANGLE:
                ServoSetPluseAndTime( 4, ServoPwmDutySet[4] - 30, 50 );
                break;
              case PSB_CROSS:
                ServoSetPluseAndTime( 4, ServoPwmDutySet[4] + 30, 50 );
                break;
              ...
              case PSB_R2:
                ...
                break;
              case PSB_CIRCLE:
                ServoSetPluseAndTime( 3, ServoPwmDutySet[3] + 30, 50 );
                break;
              case PSB_SQUARE:
                ServoSetPluseAndTime( 3, ServoPwmDutySet[3] - 30, 50 );
                break;
